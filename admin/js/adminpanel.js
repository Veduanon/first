        ...
        firebase.database().ref("news/Aboutcompany/logo_aboutcompany").get().then((snapshot) => {
          ...
          firebase.database().ref("news/Contact").get().then((snapshot) => {
            ...
            <div class="section_6_1">
                    ...
                    <img id="IconContact1" src="${data.IconURL1}" alt="" style="height: 32px; width: 32px;">
                    ...
                    <img id="IconContact2" src="${data.IconURL2}" alt="" style="height: 32px; width: 32px;">
                    ...
                    <img id="IconContact3" src="${data.IconURL3}" alt="" style="height: 32px; width: 32px;">
